...
from hldesk.models import Ticket, Queue
...
class TestKBDisabled(TestCase):
    ...
    def test_ticket_by_link(self):
        ...
        # http://example.com/hldesk/view/?ticket=q1-1&email=None
        response = self.client.get(reverse('hldesk:public_view'),
    ...
    def test_ticket_with_changed_queue(self):
        ...
        url = reverse('hldesk:public_view')
