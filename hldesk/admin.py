...
from hldesk.models import Queue, Ticket, FollowUp, PreSetReply, KBCategory
from hldesk.models import EscalationExclusion, EmailTemplate, KBItem
from hldesk.models import TicketChange, Attachment, IgnoreEmail
from hldesk.models import CustomField
