...
from hldesk.models import Ticket, FollowUp, Queue

User = get_user_model()


class OpenTicketsByUser(Feed):
    title_template = 'hldesk/rss/ticket_title.html'
    description_template = 'hldesk/rss/ticket_description.html'
...
class UnassignedTickets(Feed):
    ...
    link = ''  # '%s?assigned_to=' % reverse('hldesk:list')
...
class RecentFollowUps(Feed):
    title_template = 'hldesk/rss/recent_activity_title.html'
    description_template = 'hldesk/rss/recent_activity_description.html'
    ...
    link = '/tickets/'  # reverse('hldesk:list')
