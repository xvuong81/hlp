...
from hldesk.models import (Ticket, Queue, FollowUp, Attachment, IgnoreEmail, TicketCC,
...
class TicketCCForm(forms.ModelForm):
    ''' Adds either an email address or hldesk user as a CC on a Ticket. Used for processing POST requests. '''
    ...
    def __init__(self, *args, **kwargs):
        ...
        if hldesk_settings.HELPDESK_STAFF_ONLY_TICKET_CC:
...
class TicketCCUserForm(forms.ModelForm):
    ''' Adds a hldesk user as a CC on a Ticket '''
