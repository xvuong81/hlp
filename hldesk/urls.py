...
from hldesk.views import feeds, staff, public, kb, login
...
urlpatterns += [
    ...
    url(r'^logout/$',
        auth_views.LogoutView.as_view(
            template_name='hldesk/registration/login.html',
            next_page='../'),
        name='logout'),

    url(r'^password_change/$',
        auth_views.PasswordChangeView.as_view(
            template_name='hldesk/registration/change_password.html',
            success_url='./done'),
        name='password_change'),

    url(r'^password_change/done$',
        auth_views.PasswordChangeDoneView.as_view(
            template_name='hldesk/registration/change_password_done.html',),
...
urlpatterns += [
    url(r'^help/context/$',
        TemplateView.as_view(template_name='hldesk/help_context.html'),
        name='help_context'),

    url(r'^system_settings/$',
        DirectTemplateView.as_view(template_name='hldesk/system_settings.html'),
